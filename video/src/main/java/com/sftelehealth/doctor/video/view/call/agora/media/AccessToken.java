package com.sftelehealth.doctor.video.view.call.agora.media;

import java.io.ByteArrayOutputStream;
import java.io.IOException;
import java.util.TreeMap;

import static com.sftelehealth.doctor.video.view.call.agora.media.Utils.crc32;
...
public class AccessToken {
    ...
    public String build() throws Exception {
        ...
        byte[] content = Utils.pack((PackableEx) packContent);
